...
public class MgBlockCommandInstructionCreationService extends MgService {
    ...
    public static List<MgInstruction> create(MgStaticalEntity owner, List<MgStandaloneCommand> commands, CommandContext commandContext, List<MgInstanceVariable> variables){
